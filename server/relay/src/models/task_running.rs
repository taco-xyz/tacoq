...
mod tests {
    ...
    #[test]
    fn test_task_running_update_avro_serialization_benchmark() {
        let n = 10_000;
        let update = TaskRunningUpdate::new(
            Uuid::new_v4(),
        ...
        for _ in 0..n {
            let result = update.try_into_avro_bytes().unwrap();
        ...
        for result in serialized_results {
            let _task_deserialized = TaskRunningUpdate::try_from_avro_bytes(&result).unwrap();
        }
